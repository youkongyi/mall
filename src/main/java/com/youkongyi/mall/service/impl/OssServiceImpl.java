...
import com.youkongyi.mall.dto.OssCallbackParam;
...
public class OssServiceImpl implements IOssService {
    ...
    public OssPolicyResult policy() {
        ...
        // 存储目录
        String dir = ALIYUN_OSS_DIR_PREFIX+ DatePattern.PURE_DATE_FORMAT.format(DateUtil.date());
        // 签名有效期
        long expireEndTime = DateUtil.current() + ALIYUN_OSS_EXPIRE * 1000L;
